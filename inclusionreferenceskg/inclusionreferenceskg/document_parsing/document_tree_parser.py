...
from inclusionreferenceskg.inclusionreferenceskg.document_parsing.node.subparagraph import Paragraph
...
from inclusionreferenceskg.inclusionreferenceskg.document_parsing.preprocessing.block_preprocessor import \
    BlockPreprocessor
from inclusionreferenceskg.inclusionreferenceskg.document_parsing.preprocessing.footnote_preprocessor import \
    FootnotePreprocessor
from inclusionreferenceskg.inclusionreferenceskg.document_parsing.preprocessing.header_preprocessor import \
    HeaderPreprocessor
...
class DocumentTreeParser:
    ...
    def __init__(self, node_patterns=None, preprocessors: Optional[List[Type[BlockPreprocessor]]] = None):
        ...
        if node_patterns is None:
            node_patterns = [Chapter, Article, Paragraph, Point, Subparagraph]
